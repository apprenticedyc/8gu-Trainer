...
import com.hex.mianshi.common.DeleteRequest;
import com.hex.mianshi.common.ErrorCode;
import com.hex.mianshi.common.ResultUtils;
import com.hex.mianshi.constant.UserConstant;
import com.hex.mianshi.exception.BusinessException;
import com.hex.mianshi.exception.ThrowUtils;
import com.hex.mianshi.model.dto.questionQuestionBank.QuestionBankQuestionAddRequest;
import com.hex.mianshi.model.dto.questionQuestionBank.QuestionBankQuestionQueryRequest;
import com.hex.mianshi.model.dto.questionQuestionBank.QuestionBankQuestionRemoveRequest;
import com.hex.mianshi.model.dto.questionQuestionBank.QuestionBankQuestionUpdateRequest;
...
public class QuestionBankQuestionController {
    ...
    public BaseResponse<Long> addQuestionBankQuestion(
            @RequestBody QuestionBankQuestionAddRequest questionBankQuestionAddRequest, HttpServletRequest request) {
        ThrowUtils.throwIf(questionBankQuestionAddRequest == null, ErrorCode.PARAMS_ERROR);
        QuestionBankQuestion questionBankQuestion = new QuestionBankQuestion();
        BeanUtils.copyProperties(questionBankQuestionAddRequest, questionBankQuestion);
        // 数据校验
        questionBankQuestionService.validQuestionBankQuestion(questionBankQuestion, true);
        questionBankQuestion.setUserId(getCurrentUserId(request));
        // 写入数据库
    ...
    public BaseResponse<Page<QuestionBankQuestionVO>> listMyQuestionBankQuestionVOByPage(
        ...
        // 补充查询条件，只查询当前登录用户的数据
        questionBankQuestionQueryRequest.setUserId(getCurrentUserId(request));
        long current = questionBankQuestionQueryRequest.getCurrent();
        long size = questionBankQuestionQueryRequest.getPageSize();
        // 限制爬虫
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
